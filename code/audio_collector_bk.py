...
def fetch_and_combine_last_audio(api_url, base_url, combined_file_path, processed_files):
    """
    ...
    :param base_url: Base URL for audio file paths in the playlist.
...
# Configuration
API_URL = "https://w12.881903.com/edge-ts/903hd/chunks.m3u8?sessionId=C3b6AoKSKbEgwf5M&r=BkrTff0ZAyF623bQ&wmsAuthSign=c2VydmVyX3RpbWU9MTIvNC8yMDI0IDc6MDc6MDMgQU0maGFzaF92YWx1ZT1OY05XNTk0VnEwUXRUd1llV3ZzcFF3PT0mdmFsaWRtaW51dGVzPTE0NDA%3D"
BASE_URL = "https://w12.881903.com/edge-ts/903hd/"
...
while True:
    ...
    if current_period:
        ...
        fetch_and_combine_last_audio(API_URL, BASE_URL, current_combined_file, PROCESSED_FILES)
    else:
